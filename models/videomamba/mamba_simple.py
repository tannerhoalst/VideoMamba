...
try:
    _SELECTIVE_SCAN_HAS_INITIAL_STATE = "initial_state" in inspect.signature(
        selective_scan_fn
    ).parameters
...
class Mamba(nn.Module):
    ...
    def forward(self, hidden_states, inference_params=None, ssm_state: Optional[Tensor] = None):
        """
        hidden_states: (B, L, D)
        ...
        if inference_params is not None:
            conv_state, cache_state = self._get_states_from_cache(inference_params, batch)
